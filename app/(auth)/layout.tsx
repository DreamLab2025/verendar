    ...
    <div className="relative grid min-h-screen grid-cols-1 lg:grid-cols-2">
      <div className="relative hidden w-full flex-col bg-zinc-50 p-10 text-zinc-900 lg:flex">
        ...
        <div className="relative z-20 flex items-center gap-2 text-lg font-medium">
          <Image width={180} height={180} src="/logo.svg" alt="Verendar Logo" className="h-14" />
        </div>
      ...
      <div className="relative flex w-full flex-col items-center justify-center p-4">
        ...
        <div className="absolute top-4 left-4 lg:hidden">
          <Image width={56} height={56} src="/icon.svg" alt="Verendar Icon" className="h-14 w-auto aspect-square" />
        </div>
        {children}
      </div>
    </div>
