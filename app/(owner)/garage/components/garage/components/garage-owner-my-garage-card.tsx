          ...
          <div className="relative overflow-hidden rounded-xl border border-border/70 bg-card p-4 transition-all duration-200 hover:border-primary/35 hover:shadow-md">
            ...
            <div className="relative flex flex-col gap-3 sm:flex-row sm:items-start sm:justify-between">
              <div className="flex items-start gap-3">
                ...
                <div>
                  <p className="text-lg font-semibold md:text-xl">{garage.businessName}</p>
                  <p className="text-sm text-muted-foreground">{garage.shortName}</p>
                </div>
              </div>
              <div className="flex flex-wrap items-center gap-2 sm:justify-end">
                <Badge variant={garage.status === "Active" ? "default" : "secondary"}>{garage.status}</Badge>
