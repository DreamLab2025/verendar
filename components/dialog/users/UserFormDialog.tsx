...
export function UserFormDialog({
  ...
  const { user: existingUser, isLoading: isLoadingUser } = useUserById(
    userId || "",
    mode === "edit" && !!userId && open,
  );
    ...
    if (mode === "edit" && existingUser && open) {
      reset({
        ...
        dateOfBirth: existingUser.dateOfBirth
          ? existingUser.dateOfBirth.split("T")[0]
          : "",
        ...
        <div className="space-y-2">
          ...
          {mode === "edit" && (
            <div className="flex items-center space-x-2 pt-1">
              ...
              />
              <Label htmlFor="emailVerified" className="text-xs font-normal">
                Đã xác thực email
              </Label>
            </div>
          )}
            ...
            {mode === "edit" && (
              <div className="flex items-center space-x-2 pt-1">
                <Checkbox
                  ...
                  onCheckedChange={(checked) =>
                    setValue("phoneNumberVerified", !!checked)
                  }
                />
                <Label
                  htmlFor="phoneNumberVerified"
